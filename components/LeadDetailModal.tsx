...
export const LeadDetailModal: React.FC<LeadDetailModalProps> = ({ lead, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl shadow-xl max-w-lg w-full overflow-hidden border border-slate-200/80 flex flex-col max-h-[90vh] animate-in fade-in duration-150"
      ...
      >
        ...
        <div className="p-6 border-b border-slate-100 bg-slate-50/50 relative">
          <button
            onClick={onClose}
            className="absolute top-5 right-5 p-1.5 rounded-lg text-slate-400 hover:text-slate-700 hover:bg-slate-200/60 transition-colors"
          >
          ...
          <div className="flex gap-2.5 mt-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex-1 py-2 px-3 bg-white hover:bg-slate-100 text-slate-700 rounded-xl text-xs font-medium flex items-center justify-center gap-1.5 transition-colors border border-slate-200 shadow-xs"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex-1 py-2 px-3 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-xs font-medium flex items-center justify-center gap-1.5 transition-colors shadow-xs"
            >
              <PaperAirplaneIcon className="w-3.5 h-3.5 text-slate-300" />
              Открыть Direct
            </a>
          </div>
        </div>
        ...
        <div className="p-6 overflow-y-auto space-y-5 flex-1 bg-white">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="w-5 h-5 rounded-full bg-slate-100 text-slate-600 text-xs font-medium flex items-center justify-center border border-slate-200">
                1
              </span>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {lead.lead_magnets?.codeword && (
                    <span className="inline-block mt-2 text-[11px] font-medium bg-white text-slate-700 px-2 py-0.5 rounded border border-slate-200">
          ...
          <div>
            ...
            <div className="bg-slate-50/80 rounded-xl p-3.5 border border-slate-200/70 space-y-2.5">
              <div className="flex flex-col items-end">
                <div className="max-w-[90%] bg-white border border-slate-200 text-slate-800 p-3 rounded-2xl rounded-tr-sm text-xs leading-relaxed shadow-xs">
                ...
                {lead.lead_magnets?.response_url && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-2 inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-900 hover:bg-slate-800 text-white text-xs font-medium rounded-lg transition-colors"
                  >
              ...
              {lead.public_reply_status === 'sent' && (
                <div className="pt-2.5 border-t border-slate-200/60 text-[11px] text-slate-500 flex items-center gap-1.5">
